...
final class SettingService
{
    ...
    private const DEFAULT_PAYMENT_METHODS = [
        [
            ...
            'code' => 'aba',
            'type' => 'online',
            'description' => 'Pay by card (Visa / Mastercard) via ABA PayWay.',
            'instructions' => 'Customer is redirected to the secure ABA PayWay page to pay by card.',
            'image' => '',
            'qr_image' => '',
            'bank_name' => '',
            'account_name' => '',
        ...
        [
            ...
            'code' => 'wallet',
            'type' => 'wallet',
            'description' => 'Pay instantly from your store wallet balance.',
            'instructions' => 'The order total is deducted from your wallet balance.',
            'image' => '',
            'qr_image' => '',
            'bank_name' => '',
            'account_name' => '',
        ...
        [
            ...
            'code' => 'manual_qr',
            'type' => 'manual',
            'description' => 'Customer scans your QR code / transfers and sends payment proof.',
    ...
    public function validationRules(): array
    {
        $rules = [
            ...
            'payment_methods.*.type' => ['nullable', 'string', 'in:online,manual,wallet'],
    ...
    private function normalizePaymentMethod(array $method, int $index): array
    {
        ...
        return [
            ...
            'type' => in_array($method['type'] ?? null, ['online', 'manual', 'wallet'], true) ? $method['type'] : 'online',

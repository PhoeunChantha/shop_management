...
final class SettingService
{
    ...
    private const DEFAULT_PAYMENT_METHODS = [
        ...
        [
            'id' => 'wallet',
            'name' => 'Pay by Wallet (ABA PAY)',
            'code' => 'wallet',
            'type' => 'online',
            'description' => 'Scan and pay with the ABA Mobile app (ABA PAY).',
            'instructions' => 'Customer scans the ABA PAY QR / opens the ABA Mobile app to approve the payment.',
            'image' => '',
            'qr_image' => '',
            'bank_name' => '',
            'account_name' => '',

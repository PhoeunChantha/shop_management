...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $subjects = [
            ...
            'shipping', 'taxes', 'pages', 'faqs', 'reviews', 'suppliers', 'purchase orders', 'abandoned carts', 'subscribers', 'payments', 'reports', 'saved views', 'users', 'settings', 'notifications', 'seo', 'role', 'permission',
        ];

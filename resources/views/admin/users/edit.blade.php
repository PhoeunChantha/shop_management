        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 overflow-hidden">
                <div class="flex items-center justify-between gap-4 px-6 py-5 border-b border-gray-100">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">{{ __('Edit User') }}</h3>
                        <p class="text-sm text-gray-500 mt-0.5">{{ __('Update account details and roles.') }}</p>
                    </div>

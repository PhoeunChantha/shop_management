                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('roles.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input value="{{ old('name') }}" type="text" name="name" id="name" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block  shadow-sm sm:text-sm border-gray-300 w-1/2 rounded-lg " placeholder="Enter role name">
                            @error('name')

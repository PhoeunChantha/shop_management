...
@php
    ...
    $paths = [
        ...
        'chat'    => '<path d="M4 6.5A2.5 2.5 0 0 1 6.5 4h11A2.5 2.5 0 0 1 20 6.5v7a2.5 2.5 0 0 1-2.5 2.5H9l-4.2 3.3c-.4.3-.8 0-.8-.4V6.5Z"/><path d="M8.5 10h7M8.5 13h4"/>',
        'send'    => '<path d="M4 12 20 4l-4 16-4-6.5L4 12Z"/><path d="M12 13.5 20 4"/>',

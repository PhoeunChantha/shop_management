...
<head>
    ...
    <title>{{ __('Redirecting to secure payment…') }}</title>
</head>
<body onload="document.getElementById('paywayForm').submit()"
    ...
    <div style="max-width:420px;margin:0 auto">
        ...
        <h1 style="font-size:20px;margin:0 0 8px">{{ __('Redirecting to secure payment…') }}</h1>
        <p style="color:#6b6459;font-size:14px">{{ __('Please wait while we take you to ABA PayWay to complete your payment.') }}</p>

{{-- Links-only pagination for premium tables. The surrounding <x-table-footer> already
     renders the "Showing X to Y of Z" summary, so this view intentionally omits it to
